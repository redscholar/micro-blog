...
import {classNames, UserContext} from '.'
...
const ChangePwdForm = () => {
    ...
    return (
        <div className="mt-5 w-full md:mt-3 mx-auto">
            <form method="POST" onSubmit={changePwd}>
                <div className="overflow-hidden shadow sm:rounded-md mt-10">
                    <div className="bg-white px-4 py-5 sm:p-6">
                        <div className="grid grid-cols-3 gap-6">
                            <div
                                className="col-span-1 sm:col-span-1 block text-sm font-medium text-gray-700 items-center center">
                            ...
                            <div
                                className="col-span-1 sm:col-span-1 block text-sm font-medium text-gray-700 items-center">
